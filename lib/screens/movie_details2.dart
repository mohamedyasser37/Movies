...
class MovieDetail2 extends StatelessWidget {
  static const routeName = 'MovieDetail2';
          ...
          children: [
            Container(
              ...
              child: CachedNetworkImage(
                fit: BoxFit.fill,
                imageUrl:
                'http://image.tmdb.org/t/p/w500${results2.backdropPath}' ?? '',
                // height: 170,
              ...
              child: Row(
                children: [
                  CachedNetworkImage(
                    ...
                    fit: BoxFit.fill,
                    imageUrl:
                    'http://image.tmdb.org/t/p/w500${results2.posterPath}' ??
                        '',
                    // height: 170,
                    placeholder: (context, url) =>
                        Center(child: CircularProgressIndicator()),
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Icon(Icons.star,color: Colors.amber,
                              size: 28,),
                            Text('${results2.voteAverage}',style:
                        ...
                        Container(
                          ...
                          child: Text('${results2.overview}',style:
                          TextStyle(
            ...
            FutureBuilder(
              future: ApiManager.getMovieDetail2(results2.id!),
